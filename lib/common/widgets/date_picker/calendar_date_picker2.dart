...
class CalendarDatePicker2 extends StatefulWidget {
  ...
  @override
  State<CalendarDatePicker2> createState() => _CalendarDatePickerState();
}

class _CalendarDatePickerState extends State<CalendarDatePicker2> {
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        RotationTransition(
                          turns: _controller,
                          child: Assets.icons.arrowDown.svg(colorFilter: ColorFilter.mode(controlColor, BlendMode.srcIn)),
                        ),
                      ],
                    ),
                  ),
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                const Spacer(),
                IconButton(
                  icon: Assets.icons.arrowBack.svg(colorFilter: ColorFilter.mode(controlColor, BlendMode.srcIn)),
                  tooltip: _isDisplayingFirstMonth ? null : _localizations.previousMonthTooltip,
                  onPressed: _isDisplayingFirstMonth ? null : _handlePreviousMonth,
                ),
                IconButton(
                  icon: Assets.icons.arrowForward.svg(colorFilter: ColorFilter.mode(controlColor, BlendMode.srcIn)),
