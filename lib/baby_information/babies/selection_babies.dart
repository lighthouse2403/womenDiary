...
class SelectionBaby extends StatelessWidget {
  const SelectionBaby({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => BabyBloc()..add(const LoadAllBabyEvent()),
      child: const _SelectionBabyView(),
    );
  }
}

class _SelectionBabyView extends BaseStatefulWidget {
  const _SelectionBabyView();
  @override
  State<_SelectionBabyView> createState() => __SelectionBabyViewState();
}

class __SelectionBabyViewState extends State<_SelectionBabyView> {
        ...
        slivers: [
          SliverList.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return InkWell(
                  onTap: () {
                    context.pop(baby); // Trả về chuỗi "Item 42"
                  },
                  child: Slidable(
